...
MAX_EPOCH = 250
# log setting
LOG_NAME = 'log2_CE_only_conf_scale3'
CHECKPOINT_PATH = '../../logs/IPABunny_msg/log0_batch8_scale3/checkpoint.tar'  # str or None, if is not None, model will continue to train from CHECKPOINT_PATH
# lr decay
...
# dataset settings
DATASET_DIR = 'you-path/Fraunhofer_IPA_Bin-Picking_dataset/h5_dataset/bunny/train/'
...
net.to(device)
optimizer = torch.optim.Adam(net.conf_head.parameters(), lr=BASE_LEARNING_RATE)
if CHECKPOINT_PATH is not None:
    net, _, start_epoch = load_checkpoint(CHECKPOINT_PATH, net, None, False)
    start_epoch = 0
